      ...
      <van-sticky>
       ...
       <van-swipe class="my-swipe" :autoplay="3000" indicator-color="white">
        ...
        <div class="msg">
          ...
          <p>商品id:{{gid}}</p>
          <p>库存数目：{{good.stock}}</p>
          <p>购买数目：<button @click="reduce()">-</button><input v-model="count" style="width: 50px;"><button @click="add()">+</button></p>
        </div>
        <van-goods-action class="detailBottom">
            <van-goods-action-icon @click="toCar" icon="cart-o" text="购物车" :badge="cartNum" />
